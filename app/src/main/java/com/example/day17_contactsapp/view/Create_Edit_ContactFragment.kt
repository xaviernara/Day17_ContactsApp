...
class Create_Edit_ContactFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_create__edit__contact, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment Create_Edit_ContactFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Create_Edit_ContactFragment().apply {
